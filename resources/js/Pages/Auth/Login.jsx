...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <GuestLayout>
            <Head title="Masuk - RuangSinggah.id" />

            <div className="text-center mb-10">
                <h2 className="text-3xl font-extrabold text-gray-900">Selamat Datang!</h2>
                <p className="mt-2 text-sm text-gray-500">Masuk untuk mengelola kost favoritmu</p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-5">
                <div>
                    <InputLabel htmlFor="email" value="Email" className="text-xs font-bold text-gray-400 uppercase mb-2" />
                    <TextInput
                        id="email"
                        type="email"
                        name="email"
                        value={data.email}
                        className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 focus:ring-orange-500 focus:border-orange-500 transition-all"
                ...
                <div className="mt-4">
                    <div className="flex justify-between items-center mb-2">
                        <InputLabel htmlFor="password" value="Kata Sandi" className="text-xs font-bold text-gray-400 uppercase" />
                        {canResetPassword && (
                            <Link
                    ...
                    <div className="relative">
                        <TextInput
                            ...
                            name="password"
                            value={data.password}
                            className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 pr-12 focus:ring-orange-500 focus:border-orange-500 transition-all"
                ...
                <div className="mt-6">
                    <PrimaryButton 
                        className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-xl shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2" 
                        disabled={processing}
                    >
                        {processing && (
            ...
            {/* Social Login Section (Sesuai kode lama Anda) */}
            <div className="mt-8">
                <div className="relative">
            ...
            <div className="mt-8 text-center">
                <p className="text-sm font-medium text-gray-500">
                    Belum punya akun?{' '}
                    <Link href={route('register')} className="text-orange-500 font-bold hover:text-orange-600 hover:underline">
                        Daftar Sekarang
                    </Link>
                </p>
            </div>
