...
export default function GuestLayout({ children }) {
    // Kita tetap ambil auth untuk berjaga-jaga jika user mengakses login saat sudah masuk
    const { auth } = usePage().props;

    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 flex flex-col">
            {/* Navigation - Dibuat identik dengan AppLayout */}
            <nav className="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-20 items-center">
                        ...
                        {/* Menu Tengah: Sekarang tetap tampil di Login Page agar konsisten */}
                        ...
                        <div className="flex items-center space-x-4">
                            {auth.user ? (
                                <Link 
                                    ...
                                    className="bg-orange-500 text-white px-6 py-2.5 rounded-full font-bold hover:bg-orange-600 transition shadow-lg shadow-orange-200"
                                >
                                    Dashboard
                                </Link>
                            ) : (
            ...
            {/* Footer - Dibuat identik dengan AppLayout */}
